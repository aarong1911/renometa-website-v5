...
// ⚠️ We need to ensure useAppointment now exports forceRefresh
...
    timeSlots,
    resetAppointment,
    // ✨ CRITICAL FIX: Destructure the new function from useAppointment
    forceRefresh, 
  } = useAppointment();
...
      // 2. Trigger the refresh after successful booking
      forceRefresh(); // ✨ CRITICAL FIX: Refresh slots after successful booking
