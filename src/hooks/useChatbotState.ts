...
Would you like to confirm this appointment?`);
  ...
  const submitAppointment = async () => {
    ...
    try {
      ...
      addBotMessage(
        "Your appointment has been scheduled! We've sent the details to your email and our team will contact you to confirm. Is there anything else you'd like to know?"
      );

      toast({
        title: 'Appointment Scheduled',
        description: `Your appointment on ${format(
          selectedDate!,
          'MMMM d, yyyy'
        )} at ${selectedTime} has been scheduled.`,
      });
      ...
      addBotMessage(
        'Sorry, there was an error scheduling your appointment. Please try again or contact us directly at support@renometa.com.'
      );

      toast({
        title: 'Error',
        description:
          'There was a problem scheduling your appointment. Please try again.',
        variant: 'destructive',
      });
    } finally {
