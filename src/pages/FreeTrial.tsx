...
const FreeTrial = () => {
  const handleGoogleSignIn = () => {
    // Google Sign-In integration will be added here
  ...
  const features = [
    {
      ...
      description: 'Let AI handle customer inquiries 24/7, providing instant, accurate responses to common questions.',
      icon: <MessageSquare className="h-6 w-6" />,
      link: '#'
    },
    {
      title: 'Chat Logs & Insights',
      description: 'Get detailed analytics and insights from customer conversations to improve your service.',
      icon: <BarChart2 className="h-6 w-6" />,
      link: '#'
    },
    {
      title: 'Custom Branding',
      description: 'Personalize the chatbot appearance to match your brand identity seamlessly.',
      icon: <Palette className="h-6 w-6" />,
      link: '#'
    },
    {
      title: 'Real Visitor Interaction',
      description: 'Engage with website visitors in real-time and convert them into customers.',
        ...
        <div className="container-custom relative z-10">
          <div className="max-w-3xl mx-auto text-center text-white">
            ...
            <ScrollReveal delay={400}>
              <Button 
                size="lg"
                className="bg-white text-blue-dark hover:bg-gold hover:text-white transition-colors mb-4"
