...
          "h-7 w-7 p-0 font-bold aria-selected:opacity-100" // 🛑 MODIFIED: Use font-bold for all valid days
        ),
...
        day_outside:
          "day-outside text-gray-900", // 🛑 MODIFIED: Removed opacity-50 to keep future 'outside' days visible
        day_disabled: "text-muted-foreground opacity-50 pointer-events-none", // 🛑 MODIFIED: Ensures past dates/weekends are faded and unclickable
        day_range_middle:
